...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { seat_numbers: @table.seat_numbers, table_name: @table.table_name } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { seat_numbers: @table.seat_numbers, table_name: @table.table_name } }
